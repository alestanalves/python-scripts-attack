...
fig_lean = Figlet(font='lean')
fig_digital = Figlet(font='digital')
print(fig_lean.renderText('Wifi DoS Hacking Attack'))
print(fig_digital.renderText('Python script - Alestan Alves'))
